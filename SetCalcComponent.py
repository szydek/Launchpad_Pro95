...
from .SCNoteComponent import SCNoteComponent
#from .DrumGroupFinderComponent import DrumGroupFinderComponent
from .TranslationComponent import TranslationComponent
import consts
from functools import partial

class SetCalcComponent(ControlSurfaceComponent):
	"""
	...
	def __init__(self, control_surface, drum_component = None, *a, **k):
		...
		self._scale_component = SCScaleComponent(control_surface = self._control_surface, enabled = True)
		self._note_component = SCNoteComponent(
		...
		super(SetCalcComponent, self).__init__(*a, **k)
